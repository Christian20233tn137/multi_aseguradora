    ...
    <>
      ...
      >
        ...
        <div className="mt-11 p-10 rounded-lg transition-transform transform hover:scale-105">
          ...
          />
          <h2
            className="mt-4 text-base font-bold text-center flex items-center justify-center gap-2 cursor-not-allowed text-gray-500"
          >
            Editar perfil
            <img
        ...
        <ul>
          {menuItems.map(({ nombre, ruta }) => (
            <li key={nombre} className="mb-2">
              <button
                disabled
                className="w-full text-left cursor-not-allowed text-gray-500 p-2 rounded transition"
              >
                {nombre}
              </button>
            </li>
